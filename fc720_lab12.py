...
Original file is located at
    https://colab.research.google.com/drive/1CLsiE7ainrbJXCmMRoQvQOKLnEEiinmp
...
median_unemploy = (economics_wide
...
air_passengers_long = (air_passengers
                       .melt(id_vars=["Year"],value_vars=month_cols,
...
std_passengers = (air_passengers_long
...
table2_wide = (table2
    .pivot(values="count", index=["country", "year"], columns="type")
    .sort(["country", "year"]))
...
highest_ratio_country = (year_1999.sort("ratio", descending=True)
    .select(pl.col("country").first())
    .item())
